...
public class Smartq {
    ...
    public void testLoginOrSignUp() throws InterruptedException {
        ...
        if (loginPage != null) {
            ...
            // Enter credentials
            usernameField.sendKeys("bamneaqdas@gmail.com");
            Thread.sleep(2000);
...
//
            ...
            // Further assertions or actions can be added here
    ...
    public void CampaignSearch() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement Search = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"myInput\"]")));
    ...
    public void logout() {
        if (shouldLogout) {
            try {
                ...
                logoutButton.click();
                Thread.sleep(2000);
                wait.until(ExpectedConditions.urlToBe("https://smartqc.io/login"));
